...
public class Spieler1 extends JFrame implements ActionListener {
    private JButton beginnespiel;

    private boolean spieler1aktiv = true;
   private static boolean anzeigen = true;
    ...
    public Spieler1() {
        ...
        JLabel titleLabel = new JLabel("Spieler1");
        ...
        JLabel infoLabel = new JLabel("Spieler 1 ist an der Reihe!");
    ...
    public boolean getspieler1aktiv() {
        return spieler1aktiv;
      }
    public void setspieler1aktiv(boolean spieler1) {
        this.spieler1aktiv = spieler1aktiv; 
    }
